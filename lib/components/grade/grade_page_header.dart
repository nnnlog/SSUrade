          ...
          children: [
            Row(
              ...
              children: [
                BlocBuilder<GradeBloc, GradeState>(
                  builder: (context, state) {
                    ...
                    return DropdownButton(
                      ...
                      items:
                          state.semesterSubjectsManager.data.entries
                              .map(
                      ...
                      style: TextStyle(fontSize: 17, color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.w500, fontFamily: "Pretendard"),
                      underline: Container(),
                ...
                TextButton(
                  onPressed:
                      context.read<GradeBloc>().state is GradeShowing
                          ? () {
                            context.read<GradeBloc>().add(
                              GradeInformationRefreshRequested((context.read<GradeBloc>().state as GradeShowing).showingSemester),
                            );
                          }
                          : null,
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("나의 평균 학점", style: TextStyle(fontSize: 16, color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.w700)),
                    Row(
                      crossAxisAlignment: CrossAxisAlignment.baseline,
                      textBaseline: TextBaseline.alphabetic,
                      children: [
                        BlocSelector<GradeBloc, GradeState, String>(
                          selector: (state) {
                          ...
                          builder: (context, value) {
                            return Text(value, style: const TextStyle(fontSize: 50, fontWeight: FontWeight.w600));
                          },
                        ),
                        const SizedBox(width: 3),
                        Text("/ 4.50", style: TextStyle(fontSize: 20, color: Colors.black.withOpacity(0.5), fontWeight: FontWeight.w700)),
                      ],
                    ),
                  ],
                ),
                  ...
                  builder: (context, state) {
                    ...
                    return Visibility(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("학기 석차", style: TextStyle(fontSize: 14, color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.w700)),
                          ...
                          Text("전체 석차", style: TextStyle(fontSize: 14, color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.w700)),
                          const SizedBox(height: 2),
                          Text(
