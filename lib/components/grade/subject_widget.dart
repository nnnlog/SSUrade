    ...
    return Container(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Colors.white,
          boxShadow: [BoxShadow(blurRadius: 6, spreadRadius: 1, offset: const Offset(0, 2), color: Colors.black.withOpacity(0.1))],
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 17, color: Colors.black),
                        softWrap: true,
                      ),
                      Text(
                        ...
                        ...e.entries.map<Row>(
                          (entry) => Row(
                            ...
                            children: [
                              ...
                              Flexible(
                                child: SelectableText(entry.value, textAlign: TextAlign.right, style: const TextStyle(fontWeight: FontWeight.w500)),
                              ),
                            ],
                          ),
                        ),
