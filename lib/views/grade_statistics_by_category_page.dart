...
class _GradeStatisticsByCategoryPageState extends State<GradeStatisticsByCategoryPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<GradeInquiryBloc, GradeInquiryState>(
                    ...
                    child: TabBar(
                      tabs:
                          (data.keys.toList()
                                ...
                                ..insert(0, _key1))
                              .map((e) => SizedBox(height: 50, child: Center(child: Text(e))))
                              .toList(),
                      isScrollable: true,
                                      ...
                                      rows:
                                          [
                                                ...
                                                (
                                                  "이수 학점 수",
                                                  data[key]!
                                                      .map((e) => e.$1.excluded ? 0 : e.$1.credit)
                                                ...
                                                (
                                                  "P/F 제외 이수 학점 수",
                                                  data[key]!
                                                      .map((e) => e.$1.excluded || e.$1.isPassFail ? 0 : e.$1.credit)
                                                      .fold(0.0, (value, element) => value + element)
                                                      .toString(),
                                                ),
                                                (
                                                ...
                                                (e) => DataRow(
                                                  cells: [
                                                    ...
                                                    DataCell(
                                                      SizedBox(
                                                        width: MediaQuery.of(context).size.width * 0.5,
                                                        child: Text(e.$2, textAlign: TextAlign.center, softWrap: true),
                                                      ),
                                                    ),
                                                  ],
                                                ),
                                                    ...
                                                    DataCell(
                                                      SizedBox(
                                                        ...
                                                        child: Text(
                                                          ...
                                                          softWrap: true,
                                                          style: TextStyle(
                                                            decoration: e.$1.excluded ? TextDecoration.lineThrough : TextDecoration.none,
                                                          ),
                                                        ),
                                                      ),
                                                    ),
