  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<GradeInquiryBloc, GradeInquiryState>(
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      ...
                      color: Colors.white,
                      boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.15), spreadRadius: 3, blurRadius: 10, offset: const Offset(0, 3))],
                    ),
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              const Flexible(
                                fit: FlexFit.tight,
                                child: Text("전체 평점", style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600), textAlign: TextAlign.left),
                              ),
                              Flexible(
                                fit: FlexFit.tight,
                                child: Row(
                                  ...
                                  textBaseline: TextBaseline.alphabetic,
                                  children: [
                                    BlocSelector<GradeInquiryBloc, GradeInquiryState, String>(
                                      selector: (state) {
                                        if (state is GradeInquiryShowing) {
                                          return state.semesterSubjectsManager.data.values
                                              .map(
                                                (semesterSubjects) => (semesterSubjects.currentSemester, semesterSubjects.subjects.values.toList()),
                                              )
                                      ...
                                      builder: (context, state) {
                                        return Text(state, style: const TextStyle(fontSize: 40, fontWeight: FontWeight.w600));
                                      },
                                    ),
                                    const SizedBox(width: 3),
                                    Text("/ 4.50", style: TextStyle(fontSize: 16, color: Colors.black.withOpacity(0.5), fontWeight: FontWeight.w600)),
                                  ],
                                ),
                              ),
                            ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    BlocSelector<GradeInquiryBloc, GradeInquiryState, String>(
                                      ...
                                      builder: (context, state) {
                                        return Text(state, style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w600));
                                      },
                                    ),
                                    const SizedBox(width: 3),
                                    Text("/ 4.50", style: TextStyle(fontSize: 13, color: Colors.black.withOpacity(0.5), fontWeight: FontWeight.w600)),
                                  ],
                                ),
                              ),
                            ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    BlocSelector<GradeInquiryBloc, GradeInquiryState, String>(
                                      ...
                                      builder: (context, state) {
                                        return Text(state, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600));
                                      },
                                    ),
                                  ],
                                ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        BlocSelector<GradeInquiryBloc, GradeInquiryState, SplayTreeMap<YearSemester, SemesterSubjects>>(
                          selector: (state) {
                            if (state is GradeInquiryShowing) {
                                        ...
                                        (e) => Container(
                                          ...
                                          child: ExpansionTile(
                                            ...
                                            title: Row(
                                              ...
                                              children: [
                                                Text("  ${e.year}학년도 ${e.semester.displayText}", style: const TextStyle(fontWeight: FontWeight.w500)),
                                                Row(
                                                  crossAxisAlignment: CrossAxisAlignment.baseline,
                                                  textBaseline: TextBaseline.alphabetic,
                                                  children: [
                                                    ...
                                                    const Text(" / 4.50", style: TextStyle(fontSize: 12)),
                                                  ],
                                                ),
                                              ],
                                            ),
