          ...
          child: Padding(
            ...
            child: IntrinsicHeight(
              child: Column(
                ...
                children: [
                  const Text("이미지로 내보내기", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 17)),
                  ...
                  BlocSelector<GradeBloc, GradeState, bool>(
                    ...
                    builder: (context, isDisplayRankingDuringExporting) {
                      return SwitchListTile(value: isDisplayRankingDuringExporting, onChanged: (value) {}, dense: true, title: const Text("석차"));
                    },
                  ),
                  BlocSelector<GradeBloc, GradeState, bool>(
                    bloc: context.read<GradeBloc>(),
      ...
      child: BlocSelector<GradeBloc, GradeState, bool>(
        ...
        builder: (context, isShowingGrade) {
          return Scaffold(
                    ...
                    return Padding(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [LinearProgressIndicator(), SizedBox(width: 1, height: 15), Text("전체 학기 성적을 불러오고 있어요...")],
                        ),
                      ),
                    );
                  }),
                      ...
                      child: SingleChildScrollView(
                        child: Screenshot(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children:
                                  <Widget>[GradePageHeader()] +
                                  context.select((GradeBloc bloc) => bloc.state).let((state) {
                                    if (state is GradeShowing) {
                                      return state.semesterSubjectsManager.data[state.showingSemester]?.subjects.values
                                              .toList()
                                              .also((it) {
                                                it.sort();
                                              })
            ...
            floatingActionButton: BlocBuilder<GradeBloc, GradeState>(
              builder: (context, state) {
                if (state is GradeShowing) {
