...
class _ChapelPageState extends State<ChapelPage> with SingleTickerProviderStateMixin, AutomaticKeepAliveClientMixin<ChapelPage> {
  // late ChapelInformation state.showingChapel;
  ...
  //   setState(() {
  //     state.showingChapel = globals.chapelInformationManager.data[value]!;
  //   });
  // }

  // Future<void> refreshCurrentChapel() async {
  //   var search = state.showingChapel.currentSemester;
  ...
  //
  //     if (!mounted) return;
  //     if (search != state.showingChapel.currentSemester) return;
  //
  ...
  Widget build(BuildContext context) {
    ...
    //                       ))
    //                           .toList(),
    //                       value: state.showingChapel.currentSemester,
    ...
    //                         children: [
    //                           const SizedBox(height: 20),
    //                           ...state.showingChapel.attendances.map((e) => Container(
    //                             margin: const EdgeInsets.only(bottom: 10),
    //                             decoration: BoxDecoration(
    //                               color: Colors.white,
    //                               boxShadow: [
    ...
    //                                   ("소속", e.affiliation.isEmpty ? "-" : e.affiliation),
    //                                   ("강의명", e.lectureName),
    //                                   ("입력된 출결 상태", e.attendance.display),
    //                                   ("비고", e.lectureEtc.isEmpty ? "-" : e.lectureEtc),
    //                                 ].map((e) => Container(
    //                                   margin: const EdgeInsets.symmetric(vertical: 3),
    //                                   child: Row(
