      ...
      child: BlocSelector<ChapelBloc, ChapelState, bool>(
        ...
        builder: (context, isShowingChapel) {
          return Scaffold(
            ...
            body: BlocBuilder<ChapelBloc, ChapelState>(
                    ...
                    return const Padding(
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [LinearProgressIndicator(), SizedBox(width: 1, height: 15), Text("채플 정보를 불러오고 있어요...")],
                        ),
                      ),
                    );
                  }),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      DropdownButton(
                                        items:
                                            state.chapelManager.data.values
                                                .map(
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          Text(
                                            "Pass까지 남은 출석",
                                            style: TextStyle(fontSize: 16, color: Colors.black.withOpacity(0.6), fontWeight: FontWeight.w700),
                                          ),
                                          Row(
                                      ...
                                      Column(
                                        children:
                                            [
                                                  ("결석 횟수", state.showingChapel.absentCount.toString()),
                                                  ("강의 횟수", state.showingChapel.attendances.length.toString()),
                                                ]
                                                .map(
                                                  (e) => Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(e.$2, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500)),
                                                    ],
                                                  ),
                                                )
                                                .toList(),
                                      ...
                                      text: const TextSpan(
                                        children: [
                                          WidgetSpan(
                                            ...
                                            child: Icon(Icons.info_outline_rounded, size: 12, color: Colors.blueAccent),
                                          ),
                                          TextSpan(text: " 채플의 이수 기준은 2/3 이상의 출석입니다.", style: TextStyle(fontSize: 12, color: Colors.blueAccent)),
                                        ],
                                      ),
                                    ),
                                  ),
                            ...
                            Container(
                              color: Colors.white,
                              child: TabBar(controller: _tabController, tabs: const [Tab(text: "강의 정보"), Tab(text: "출결 정보")]),
                            ),
                            Container(
                              decoration: BoxDecoration(
                                boxShadow: [
                                  BoxShadow(color: Colors.black.withOpacity(0.15), spreadRadius: 1, blurRadius: 10, offset: const Offset(0, 3)),
                                ],
                              ),
                            ),
                            Expanded(
                                  ...
                                  Container(
                                    ...
                                    child: ListView(
                                      children: [
                                        ...[
                                          [
                                            ("과목 코드", state.showingChapel.subjectCode),
                                            ("강의실", state.showingChapel.subjectPlace),
                                            ("강의 시간", state.showingChapel.subjectTime),
                                          ],
                                              ...
                                              GestureDetector(
                                                ...
                                                onTap: () {
                                                  Navigator.push(
                                                    ...
                                                    MaterialPageRoute(
                                                      builder: (_) {
                                                        return FullScreenImage(Image.asset("assets/image/chapel.jpg"));
                                                      },
                                                    ),
                                                  );
                                                },
                                        ...
                                        RichText(
                                          text: const TextSpan(
                                            children: [
                                              WidgetSpan(
                                                alignment: PlaceholderAlignment.middle,
                                                child: Icon(Icons.info_outline_rounded, size: 12, color: Colors.redAccent),
                                              ),
                                              TextSpan(
                                        ...
                                        RichText(
                                          text: const TextSpan(
                                            children: [
                                              WidgetSpan(
                                                alignment: PlaceholderAlignment.middle,
                                                child: Icon(Icons.info_outline_rounded, size: 12, color: Colors.black54),
                                              ),
                                              TextSpan(text: " 자리 배치도 사진을 누르면 확대할 수 있어요.", style: TextStyle(fontSize: 12, color: Colors.black54)),
                                            ],
                                          ),
                                        ),
                                      ],
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            ...
                                            ...state.showingChapel.attendances.values.map(
                                              (e) => Container(
                                                margin: const EdgeInsets.only(bottom: 10),
                                                decoration: BoxDecoration(
                                                  color: Colors.white,
                                                ...
                                                child: ExpansionTile(
                                                  ...
                                                  title: Container(
                                                    ...
                                                    child: Row(
                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                      children: [
                                                        Text(e.lectureDate, style: const TextStyle(fontWeight: FontWeight.w500)),
                                                        Text(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                      children: [
                                                        const Text("출결 상태 강제 지정", textAlign: TextAlign.left, style: TextStyle(color: Colors.black54)),
                                                        DropdownButton(
                                                          isDense: true,
                                        ...
                                        RichText(
                                          text: const TextSpan(
                                            children: [
                                              ...
                                              TextSpan(
                                                text:
                                                    " '출결 상태 강제 지정'은 앱에서 표시되는 출결 상태만 변경하는 것으로 중간고사 기간의 비대면 채플이 출결 처리 되기 이전에 출석으로 표시될 수 있게끔 설계한 기능이에요.",
