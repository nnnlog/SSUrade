...
class _SettingPageState extends State<SettingPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        ...
        child: BlocSelector<SettingBloc, SettingState, int>(
            selector: (state) => state is SettingShowing ? state.setting.backgroundInterval : -1,
            builder: (context, backgroundIntervalState) {
