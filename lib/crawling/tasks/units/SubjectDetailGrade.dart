...
class SubjectDetailGrade extends CrawlingTask<Map<String, String>> {
  ...
  @override
  Future<Map<String, String>> internalExecute(Queue<InAppWebViewController> controllers) async {
    ...
    var ret = (((await controller.callAsyncJavaScript(functionBody: "return await ssurade.crawl.getGradeDetail('${search.year}', '${search.semester.keyValue}', '$subjectCode');"))!.value) ??
