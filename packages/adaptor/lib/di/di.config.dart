...
import 'package:ssurade_adaptor/application/agreement_retrieval_service.dart'
    as _i179;
import 'package:ssurade_adaptor/application/app_environment_service.dart'
    as _i78;
import 'package:ssurade_adaptor/application/app_version_fetch_service.dart'
    as _i159;
import 'package:ssurade_adaptor/application/background/background_process_management_service.dart'
    as _i717;
...
import 'package:ssurade_adaptor/persistence/localstorage/lightspeed_retrieval_service.dart'
    as _i615;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_absent_application_manager_service.dart'
    as _i420;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_chapel_manager_service.dart'
    as _i69;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_credential_service.dart'
    as _i101;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_save_photo_service.dart'
    as _i524;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_scholarship_manager_service.dart'
    as _i750;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_semester_subjects_manager_service.dart'
    as _i139;
import 'package:ssurade_adaptor/persistence/localstorage/local_storage_setting_service.dart'
    as _i47;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    final externalCredentialRetrievalServiceModule =
        _$ExternalCredentialRetrievalServiceModule();
    final localStorageCredentialServiceModule =
        _$LocalStorageCredentialServiceModule();
    gh.factory<_i1067.ExternalCredentialRetrievalPort>(
      () =>
          externalCredentialRetrievalServiceModule
              .externalCredentialRetrievalPort,
    );
    gh.factory<_i67.LocalStorageCredentialPort>(
      () => localStorageCredentialServiceModule.localStorageCredentialPort,
    );
    gh.singleton<_i27.AssetLoaderService>(() => _i27.AssetLoaderService());
    gh.singleton<_i429.CredentialRetrievalService>(
      () => _i429.CredentialRetrievalService(),
    );
    ...
    gh.singleton<_i747.AppVersionFetchPort>(
      () => _i159.AppVersionFetchService(),
    );
    gh.singleton<_i67.LocalStorageScholarshipManagerPort>(
      () => _i750.LocalStorageScholarshipManagerService(
        gh<_i289.LocalStorageClient>(),
      ),
    );
    gh.singleton<_i67.LocalStorageSavePhotoPort>(
      () => _i524.LocalStorageSavePhotoService(),
    );
    gh.singleton<_i67.LocalStorageChapelManagerPort>(
      () =>
          _i69.LocalStorageChapelManagerService(gh<_i289.LocalStorageClient>()),
    );
    gh.singleton<_i750.ToastPort>(() => _i114.ToastService());
    gh.singleton<_i67.LocalStorageAbsentApplicationManagerPort>(
      () => _i420.LocalStorageAbsentApplicationManagerService(
        gh<_i289.LocalStorageClient>(),
      ),
    );
    gh.singleton<_i67.LocalStorageSemesterSubjectsManagerPort>(
      () => _i139.LocalStorageSemesterSubjectsManagerService(
        gh<_i289.LocalStorageClient>(),
      ),
    );
    gh.singleton<_i615.LightspeedRetrievalService>(
      () => _i615.LightspeedRetrievalService(gh<_i289.LocalStorageClient>()),
    );
    gh.singleton<_i67.LocalStorageSettingPort>(
      () => _i47.LocalStorageSettingService(gh<_i289.LocalStorageClient>()),
    );
    gh.singleton<_i124.AppEnvironmentPort>(() => _i78.AppEnvironmentService());
    gh.singleton<_i67.AgreementRetrievalPort>(
      () => _i179.AgreementRetrievalService(
        assetLoaderService: gh<_i27.AssetLoaderService>(),
      ),
    );
    gh.singleton<_i101.LocalStorageCredentialService>(
      () =>
          _i101.LocalStorageCredentialService(gh<_i497.SecureStorageClient>()),
    );
    gh.singleton<_i903.CredentialManagerService>(
      () => _i903.CredentialManagerService(
        localStorageClient: gh<_i289.LocalStorageClient>(),
        localStorageCredentialService:
            gh<_i101.LocalStorageCredentialService>(),
    ...
    gh.singleton<_i333.ExternalCredentialRetrievalService>(
      () => _i333.ExternalCredentialRetrievalService(
        gh<_i722.WebViewClientService>(),
    ...
    gh.singleton<_i67.ExternalChapelManagerRetrievalPort>(
      () => _i984.ExternalChapelRetrievalService(
        gh<_i722.WebViewClientService>(),
      ),
    );
...
class _$ExternalCredentialRetrievalServiceModule
    extends _i333.ExternalCredentialRetrievalServiceModule {}

class _$LocalStorageCredentialServiceModule
    extends _i101.LocalStorageCredentialServiceModule {}
