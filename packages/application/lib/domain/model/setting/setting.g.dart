...
abstract class _$SettingCWProxy {
  ...
  /// ````
  Setting call({bool refreshInformationAutomatically, bool enableBackgroundFeature, bool showGradeInBackground, int backgroundInterval, bool agree});
}
...
class _$SettingCWProxyImpl implements _$SettingCWProxy {
  ...
  @override
  Setting refreshInformationAutomatically(bool refreshInformationAutomatically) =>
      this(refreshInformationAutomatically: refreshInformationAutomatically);
  ...
  Setting call({
    ...
    return Setting(
      refreshInformationAutomatically:
          refreshInformationAutomatically == const $CopyWithPlaceholder()
              ? _value.refreshInformationAutomatically
              // ignore: cast_nullable_to_non_nullable
              : refreshInformationAutomatically as bool,
      enableBackgroundFeature:
          enableBackgroundFeature == const $CopyWithPlaceholder()
              ? _value.enableBackgroundFeature
              // ignore: cast_nullable_to_non_nullable
              : enableBackgroundFeature as bool,
      showGradeInBackground:
          showGradeInBackground == const $CopyWithPlaceholder()
              ? _value.showGradeInBackground
              // ignore: cast_nullable_to_non_nullable
              : showGradeInBackground as bool,
      backgroundInterval:
          backgroundInterval == const $CopyWithPlaceholder()
              ? _value.backgroundInterval
              // ignore: cast_nullable_to_non_nullable
              : backgroundInterval as int,
      agree:
          agree == const $CopyWithPlaceholder()
              ? _value.agree
              // ignore: cast_nullable_to_non_nullable
              : agree as bool,
    );
