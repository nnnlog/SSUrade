...
abstract class _$LightspeedCWProxy {
  ...
  /// ````
  Lightspeed call({String version, String data});
}
...
class _$LightspeedCWProxyImpl implements _$LightspeedCWProxy {
  ...
  /// Lightspeed(...).copyWith(id: 12, name: "My name")
  /// ````
  Lightspeed call({Object? version = const $CopyWithPlaceholder(), Object? data = const $CopyWithPlaceholder()}) {
    return Lightspeed(
      version:
...
Lightspeed _$LightspeedFromJson(Map<String, dynamic> json) => Lightspeed(version: json['version'] as String, data: json['data'] as String);

Map<String, dynamic> _$LightspeedToJson(Lightspeed instance) => <String, dynamic>{'version': instance.version, 'data': instance.data};
