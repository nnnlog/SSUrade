    ...
    return Subject(
      ...
      name:
          name == const $CopyWithPlaceholder()
              ...
              : name as String,
      credit:
          credit == const $CopyWithPlaceholder()
              ? _value.credit
              // ignore: cast_nullable_to_non_nullable
              : credit as double,
      grade:
          grade == const $CopyWithPlaceholder()
              ? _value.grade
              // ignore: cast_nullable_to_non_nullable
              : grade as String,
      score:
          score == const $CopyWithPlaceholder()
              ...
              : score as String,
      professor:
          professor == const $CopyWithPlaceholder()
              ? _value.professor
              // ignore: cast_nullable_to_non_nullable
              : professor as String,
      category:
          category == const $CopyWithPlaceholder()
              ...
              : category as String,
      isPassFail:
          isPassFail == const $CopyWithPlaceholder()
              ? _value.isPassFail
              // ignore: cast_nullable_to_non_nullable
              : isPassFail as bool,
      info:
          info == const $CopyWithPlaceholder()
              ? _value.info
              // ignore: cast_nullable_to_non_nullable
              : info as String,
      detail:
          detail == const $CopyWithPlaceholder()
              ? _value.detail
              // ignore: cast_nullable_to_non_nullable
